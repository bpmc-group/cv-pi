#!/usr/bin/python3
'''
from https://github.com/raspberrypi/picamera2/blob/main/examples/opencv_mertens_merge.py
this starts & stops the camera 3 times
'''
import time
...
cv2.imwrite("runs/normal.jpg", normal)
cv2.imwrite("runs/merged.jpg", merged)